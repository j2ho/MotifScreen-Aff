...
class DataPaths:
    ...
    crossreceptorf: str = 'crossreceptor.filtered.npz'  
...
class TrainingConfig:
    ...
    def from_dict(cls, config_dict: Dict[str, Any]) -> 'TrainingConfig':
        ...
        paths = DataPaths(
            ...
            decoyf=config_dict.get('decoyf', 'decoys.BL2.npz'),
            crossreceptorf=config_dict.get('crossreceptorf', 'crossreceptor.filtered.npz')
        )
...
class TrainingDataSet(torch.utils.data.Dataset):
    ...
    def _load_crossactives(self) -> Dict:
        ...
        cross_file = os.path.join(self.config.paths.datapath, self.config.paths.crossreceptorf) 
