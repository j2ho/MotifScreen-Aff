...
class EndtoEndModel(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.class_aff_combined_module = ClassAffModule( m, c,
                                                         n_lig_emb=args.params_ligand.n_lig_global_out)
    ...
    def forward(self, Grec, Glig, keyidx, grididx, u=None,
        ...
        # 2-2) screening module with affinity prediction
        aff, absAff = self.class_aff_combined_module( z, h_key_batched,
                                                    lig_rep=h_lig_global, w_mask=key_mask, z_mask=z_mask )
        
        return Ykey_s, D_key, z_norm, cs, aff, absAff